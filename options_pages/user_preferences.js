...
import {isChristmasTime} from '/js/common.js';
...
async function start() {
  ...
  function setOptions() {
    ...
    $('#showDebugMessages').prop('checked', preferences.showDebugMessages);
  ...
  function setEvents() {
    ...
    $('#showDebugMessages').click(function () {
      preferences.showDebugMessages = $('#showDebugMessages').prop('checked');
    });
